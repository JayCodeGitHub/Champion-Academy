...
const jenzykiPage = ({ data }) => {
  ...
  <BackGroundWrapper>
    ...
    <Content>
    <MainTitle>{data.datoCmsLanguagespage.tytle}</MainTitle>
      {data.datoCmsLanguagespage.content.map(item => {
