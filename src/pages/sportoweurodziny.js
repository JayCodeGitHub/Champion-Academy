...
const sportoweurodzinyPage = ({ data }) => {
  return (
  <>
  <BackGroundWrapper>
    <Background/>
  ...
  <FitnessNavigationWrapper>
    ...
    <Content>
    <MainTitle>{data.datoCmsBirthdaypage.tytle}</MainTitle>
      {data.datoCmsBirthdaypage.content.map(item => {
...
export default sportoweurodzinyPage