...
const treningirodzinnePage = ({ data }) => {
  return (
  <>
  <BackGroundWrapper>
    <Background/>
  ...
  <FitnessNavigationWrapper>
    ...
    <Content>
    <MainTitle>{data.datoCmsFamilypage.tytle}</MainTitle>
      {data.datoCmsFamilypage.content.map(item => {
...
export default treningirodzinnePage